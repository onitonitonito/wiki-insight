...
- 이를 해결하기 위해 **PowerShell 기반 이미지 로컬라이징 파이프라인**을 적용하여, **총 105개(실제 파일 개수 기준)**의 이미지를 프로젝트 로컬 에셋(`Assets/`)으로 완벽히 다운로드받고 HTML 내 경로를 상대 경로(`../Assets/...`)로 변환 완료하였습니다.
...
| :--- | :--- | :--- | :---: | :---: |
| **Business Models** | 이야이야앤프렌즈 — 스펙이 아닌 서사 경쟁 | [그리스-디자이너와-할머니-추억을-압착한-올리브유-발표자료.html](./Business_Models/그리스-디자이너와-할머니-추억을-압착한-올리브유-발표자료.html) | 14 | ✅ 완료 |
| | 더 컨쿼러 — 100만 명을 뛰게 하다 | [더-컨쿼러-100만-명-발표자료.html](./Business_Models/더-컨쿼러-100만-명-발표자료.html) | 5 | ✅ 완료 |
| | 레벨스헬스 — 혈당 스파이크 분석 앱 | [레벨스헬스-혈당-스파이크를-분석하는-앱-발표자료.html](./Business_Models/레벨스헬스-혈당-스파이크를-분석하는-앱-발표자료.html) | 6 | ✅ 완료 |
| | 블랙썬더 — 30년 만의 역전극 | [블랙썬더-30년-역전극-발표자료.html](./Business_Models/블랙썬더-30년-역전극-발표자료.html) | 8 | ✅ 완료 |
| | 스크럽대디 — 5000억 부활의 비밀 | [스크럽대디-5000억-부활의-비밀-발표자료.html](./Business_Models/스크럽대디-5000억-부활의-비밀-발표자료.html) | 7 | ✅ 완료 |
| | 스타벅스코리아 — 위기관리 실패와 3H 프레임워크 | [스타벅스코리아-리스크매니지먼트-발표자료.html](./Business_Models/스타벅스코리아-리스크매니지먼트-발표자료.html) | 6 | ✅ 완료 |
| | 카바 CAVA — 지중해식 동네식당 1조원 브랜딩 | [카바-CAVA-1조원-브랜딩-발표자료.html](./Business_Models/카바-CAVA-1조원-브랜딩-발표자료.html) | 7 | ✅ 완료 |
| | 투비(Tubi) — B급 OTT의 파괴적 혁신 | [투비-B급OTT-발표자료.html](./Business_Models/투비-B급OTT-발표자료.html) | 8 | ✅ 완료 |
| | 알렉스 퍼거슨 — 5가지 리더십 원칙 | [퍼거슨-리더십-발표자료.html](./Business_Models/퍼거슨-리더십-발표자료.html) | 21 | ✅ 완료 |
| **Idea & Insights** | 바이브시대 카페사장이 AI와 공존하는 법 | [바이브시대-카페사장-발표자료.html](./Idea_Insights/바이브시대-카페사장-발표자료.html) | 9 | ✅ 완료 |
| | 안유진 — 멀티페르소나 브랜드 전략 분석 | [안유진-멀티페르소나-발표자료.html](./Idea_Insights/안유진-멀티페르소나-발표자료.html) | 7 | ✅ 완료 |
...
| **Tech & Infra** | 안드레 카파시 — 에이전트 엔지니어링 심층 분석 | [안드레-카파시-에이전트-엔지니어링-발표자료.html](./Tech_Infra/안드레-카파시-에이전트-엔지니어링-발표자료.html) | 3 | ✅ 완료 |
| | 검색을 넘어 축적으로: LLM-Wiki의 철학과 구현 | [LLM-Wiki-철학과-구현-발표자료.html](./Tech_Infra/LLM-Wiki-철학과-구현-발표자료.html) | 5 | ✅ 완료 |
